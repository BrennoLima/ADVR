    ...
    return(
        <div className="container-fluid navbar-container" id="navbar-container">
            ...
            <BlackNavbar dark expand="md">
                <NavbarBrand className="navbar-brand" href="/">ADVR<i className="fas fa-mountain ml-2"/></NavbarBrand>
                    ...
                    <Collapse isOpen={isOpen} navbar>
                        <Nav className="ml-auto" navbar>
                            ...
                            <NavItem>
                                <ButtonSignIn  onClick={toggleModal}>Sign-in</ButtonSignIn>
                            </NavItem>
                        </Nav>
                    </Collapse>
                </BlackNavbar>
                    ...
                    <ModalBody>
                        <form className="container" onSubmit={handleSubmit(onSubmit)}>
                                ...
                                <div className="row justify-content-center">
                                    <ErrorMessage error={errors.email} className="col-12"/>
                                </div>
                                <div className="row justify-content-left m-1">
                                ...
                                <div className="row justify-content-center">
                                    <ErrorMessage error={errors.password} className="col-12"/>
                                </div>
                                <div className="row justify-content-center mt-3">
                                    <ButtonSignInModal className="col-3 col-md-3" outline 
                                        color="primary" type="submit">Sign in</ButtonSignInModal>
                                    
                                    <Button className="col-3 col-md-3 offset-1" 
                                        outline color="secondary" onClick={toggleModal}>Cancel</Button>
                                </div>
                        </form>      
                    </ModalBody>
                    <ModalFooter className="justify-content-center">
                        <p>New to ADVR? <Link to="/signin" className="joinnowbtn" onClick={toggleModal}>Join now!</Link></p>
                    </ModalFooter>
                </Modal>
            </OnOutsiceClick>
        </div>
